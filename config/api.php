...
return [
    ...
    'allow_non_expiring_tokens' => filter_var(env('API_ALLOW_NON_EXPIRING_TOKENS', false), FILTER_VALIDATE_BOOL),
    'token_retention_days' => (int) env('API_TOKEN_RETENTION_DAYS', 30),
    'prune_inactive_user_tokens' => filter_var(env('API_PRUNE_INACTIVE_USER_TOKENS', true), FILTER_VALIDATE_BOOL),
