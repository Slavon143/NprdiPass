...
class RestoreAttributeDefinitionAction extends AttributeAction
{
    public function execute(User $actor, Company $company, AttributeDefinition $definition): AttributeDefinition
    {
        ...
        return DB::transaction(function () use ($actor, $company, $definition): AttributeDefinition {
            ...
            $definition->forceFill(['status' => AttributeDefinitionStatus::Active, 'updated_by' => $actor->getKey()])->save();
            $this->auditLogger->logTenant($company, AuditEvent::CatalogAttributeRestored, $actor, $definition, [
