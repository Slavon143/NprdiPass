...
class CatalogProductNamePresent implements PassportReadinessRule
{
    public function code(): string
    {
        return 'catalog.product.name.present';
    }
    ...
    public function evaluate(ReadinessEvaluationContext $context): ReadinessRuleResult
    {
        ...
        return new ReadinessRuleResult(
            ...
            titleKey: 'readiness.catalog.product.name.present.title',
            messageKey: $passed ? 'readiness.catalog.product.name.present.passed' : 'readiness.catalog.product.name.present.failed',
