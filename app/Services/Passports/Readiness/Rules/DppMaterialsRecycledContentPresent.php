...
class DppMaterialsRecycledContentPresent implements PassportReadinessRule
{
    public function code(): string
    {
        return 'dpp.materials.recycled_content.present';
    }
    ...
    public function evaluate(ReadinessEvaluationContext $context): ReadinessRuleResult
    {
        ...
        if (! in_array(DppSectionKey::MaterialsAndComposition->value, $enabledSections, true)) {
            return new ReadinessRuleResult(
                ...
                titleKey: 'readiness.dpp.materials.recycled_content.present.title',
                messageKey: 'readiness.dpp.materials.recycled_content.present.not_applicable',
        ...
        if (! is_array($materials) || count($materials) === 0) {
            return new ReadinessRuleResult(
                ...
                titleKey: 'readiness.dpp.materials.recycled_content.present.title',
                messageKey: 'readiness.dpp.materials.recycled_content.present.failed',
        ...
        foreach ($materials as $material) {
            if (isset($material['recycled_content_percentage']) && is_numeric($material['recycled_content_percentage'])) {
                $hasRecycledContent = true;
                break;
            }
        }
        ...
        return new ReadinessRuleResult(
            ...
            group: $this->group(),
            severity: $this->severity(),
            status: $hasRecycledContent ? ReadinessRuleStatus::Passed : ReadinessRuleStatus::Failed,
            titleKey: 'readiness.dpp.materials.recycled_content.present.title',
            messageKey: $hasRecycledContent ? 'readiness.dpp.materials.recycled_content.present.passed' : 'readiness.dpp.materials.recycled_content.present.failed',
            section: DppSectionKey::MaterialsAndComposition,
            field: 'materials',
            ...
            safeContext: [
                ...
                'has_recycled_content' => $hasRecycledContent,
            ],
        );
    }
}
